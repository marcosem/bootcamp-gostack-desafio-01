...
server.put('/projects/:id', checkValidProject, (req, res) => {
  const { id } = req.params;
...
server.delete('/projects/:id', checkValidProject, (req, res) => {
  const { id } = req.params;
...
server.post('/projects/:id/tasks', checkValidProject, (req, res) => {
  const { id } = req.params;
